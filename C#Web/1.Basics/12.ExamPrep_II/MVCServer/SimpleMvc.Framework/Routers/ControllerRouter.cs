    ...
    public class ControllerRouter : IHandleable
    {
            ...
            ParameterValidator parameterValidator)
        {
            ...
            for (int index = 0; index < parameterDescriptions.Length; index++)
            {
                ...
                {
                    // POST request -> models
                    // Here we will extend the framework with our custom class ->
                    // ParameterValidator
        ...
        private Controller GetController(string controllerName, IHttpRequest request)
        {
            ...
            if (controller != null)
            {
                ...
                controller.InitializeAuthorization();
            }
            ...
            ParameterValidator parameterValidator)
        {
            ...
            foreach (var property in modelProperties)
            {
                ...
                {
                    parameterValidator.AddModelError(property.Name, $"Mapping of the {property.Name} field failed.");
                }
            }
