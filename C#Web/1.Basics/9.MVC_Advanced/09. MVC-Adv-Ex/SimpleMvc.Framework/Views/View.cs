namespace SimpleMvc.Framework.Views
{
    ...
    public class View : IRenderable
    {
        ...
        private string ReadFile()
        {
            ...
            string templateFileContent = File.ReadAllText(templateFullQualifiedNameWithExtension);

            string result = templateFileContent.Replace(ContentPlaceholder, templateFileContent);
