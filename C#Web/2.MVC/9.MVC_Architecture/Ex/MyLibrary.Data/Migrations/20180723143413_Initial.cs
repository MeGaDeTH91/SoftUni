    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieBorrows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieBorrows_Borrowers_BorrowerId",
                        column: x => x.BorrowerId,
                        principalTable: "Borrowers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieBorrows_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieBorrows_BorrowerId",
                table: "MovieBorrows",
                column: "BorrowerId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieBorrows_MovieId",
                table: "MovieBorrows",
                column: "MovieId");
