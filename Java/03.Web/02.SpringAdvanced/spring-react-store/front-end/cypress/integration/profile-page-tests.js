describe("Profile page", () => {
  beforeEach(() => {
    ...
    cy.get("input[name=username]").type("marto10");
  ...
  it("Should show all user information correctly!", () => {
    cy.get("h1").contains('Martin Taskov10');
  ...
  it("Should throw error on update user information with invalid full name!", () => {
    ...
    cy.get("div").contains("Error occurred: Enter valid last name.");
