...
public class TaskController {
    ...
    public String createProcess(Model model, TaskBindingModel taskBindingModel) {
        ...
        Task task = new Task(taskBindingModel.getTitle(), taskBindingModel.getComments()); // Правим нов Task и му задаваме Title и Comments

        taskRepository.saveAndFlush(task); // Запазваме в Базата
